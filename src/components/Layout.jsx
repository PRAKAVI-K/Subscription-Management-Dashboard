                    ...
                    <div className="flex justify-between items-center h-16">
                        ...
                        <div className="flex items-center space-x-8">
                            ...
                            <div className="hidden md:flex space-x-1">
                                <Link
                                    to="/dashboard"
                                    className={`relative px-4 py-2 rounded-lg text-sm font-semibold transition-all duration-300 group ${isActive('/dashboard')
                                        ? 'text-white'
                                ...
                                <Link
                                    to="/plans"
                                    className={`relative px-4 py-2 rounded-lg text-sm font-semibold transition-all duration-300 group ${isActive('/plans')
                                        ? 'text-white'
                                        : 'text-gray-300 hover:text-white'
                                        }`}
                                >
                                ...
                                {user?.role === 'admin' && (
                                    <Link
                                        ...
                                        className={`relative px-4 py-2 rounded-lg text-sm font-semibold transition-all duration-300 group ${isActive('/admin/subscriptions')
                                            ? 'text-white'
                                            : 'text-gray-300 hover:text-white'
                                            }`}
                                    >
                        ...
                        <div className="md:hidden pb-4 animate-slide-down">
                            <div className="space-y-2 pt-2">
                                <Link
                                    ...
                                    className={`block px-4 py-3 rounded-lg text-sm font-semibold transition-all duration-300 ${isActive('/dashboard')
                                ...
                                <Link
                                    to="/plans"
                                    onClick={() => setMobileMenuOpen(false)}
                                    className={`block px-4 py-3 rounded-lg text-sm font-semibold transition-all duration-300 ${isActive('/plans')
                                        ? 'bg-gradient-to-r from-indigo-600 to-purple-600 text-white'
                                        : 'text-gray-300 hover:bg-white/5 hover:text-white'
                                        }`}
                                >
                                ...
                                {user?.role === 'admin' && (
                                    <Link
                                        to="/admin/subscriptions"
                                        onClick={() => setMobileMenuOpen(false)}
                                        className={`block px-4 py-3 rounded-lg text-sm font-semibold transition-all duration-300 ${isActive('/admin/subscriptions')
                                            ? 'bg-gradient-to-r from-indigo-600 to-purple-600 text-white'
                                            : 'text-gray-300 hover:bg-white/5 hover:text-white'
                                            }`}
                                    >
